...
int button_command_handler(int argc, char** argv) {
    ...
    if (strcmp(argv[1], "up") == 0) {
        PageManager_handle_input(BUTTON_CODE_UP);
    } else if (strcmp(argv[1], "down") == 0) {
        PageManager_handle_input(BUTTON_CODE_DOWN);
    } else if (strcmp(argv[1], "left") == 0) {
        PageManager_handle_input(BUTTON_CODE_LEFT);
    } else if (strcmp(argv[1], "right") == 0) {
        PageManager_handle_input(BUTTON_CODE_RIGHT);
    } else if (strcmp(argv[1], "accept") == 0) {
        PageManager_handle_input(BUTTON_CODE_ACCEPT);
    } else if (strcmp(argv[1], "cancel") == 0) {
        PageManager_handle_input(BUTTON_CODE_CANCEL);
    } else if (strcmp(argv[1], "set") == 0) {
        PageManager_handle_input(BUTTON_CODE_SET);
    } else if (strcmp(argv[1], "menu") == 0) {
        PageManager_handle_input(BUTTON_CODE_MENU);
    } else {
